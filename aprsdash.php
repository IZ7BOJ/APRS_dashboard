...
<iframe src="https://aprs-map.info/?snamelist=<?php echo $stationsquery ?>"width="800" height="400">Alternative text for browsers that do not understand IFrames.</iframe>
